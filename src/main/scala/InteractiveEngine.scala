...
class InteractiveEngine { this: Layout =>
  ...
  def put(c: Char): Unit = {
    (mixedMode, compositionLevel, lastChar, this.getStroke(c)) match {
      ...
      case (true, _, Some(23), Some(26)) => { lastChar = None }
